...
public class IgniteAPITest {
    ...
    public void isUserExistsTest() {
        authentication();
        if (mTestClient.isSysUserExists("greenhouse2017@testuser.com")) {
    ...
    public void getLastDataTest() {
        authentication();
        LastThingData mLastThingData = mTestClient.getLastData(TEST_DEVICE_ID, TEST_NODE_ID, TEST_THING_ID);
